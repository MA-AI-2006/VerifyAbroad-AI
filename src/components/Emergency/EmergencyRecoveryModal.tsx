        ...
        ? createPortal(
            <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto p-3 sm:p-6">
              ...
              <div
                ...
                className="pop-in relative my-auto flex max-h-[94dvh] w-full max-w-4xl flex-col overflow-hidden rounded-[26px] border border-white bg-canvas shadow-[0_40px_90px_-40px_rgba(34,48,74,0.85)] sm:max-h-[90dvh] sm:rounded-[32px]"
              >
